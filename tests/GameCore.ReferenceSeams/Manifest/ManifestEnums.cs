...
// Enum literals are the identifiers used by docs/game-core/00-core-protocols.md and
// docs/game-core/05-contracts-and-data-model.md; keep them verbatim so diagnostics and fixtures
// can compare against the normative text.
#nullable enable
