...
// Fixed-step time debt as an exact integer tick count. Accumulation and consumption are pure arithmetic; the
// catch-up limit and the decision to keep or discard debt belong to the host (P-036: debt is retained, never
// silently converted into a longer step or dropped).
#nullable enable
using System;
