...
// Canonical semantics: docs/game-core/00-core-protocols.md P-004 (stable identities) and
// docs/game-core/05-contracts-and-data-model.md s2. Comparison and byte writing only; no runtime.
#nullable enable
using System;
