...
// Plan/delta shape from docs/game-core/05-contracts-and-data-model.md s4: composition, derivation and
// runtime deltas, staged resources and validity/cost. The seam holds immutable data only; it never
// captures writable world access, stale component pointers or plugin-supplied closure delegates.
#nullable enable
