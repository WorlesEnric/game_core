...
// Composition control-lane seam for GC-004: admission and status query, scope/install snapshots, epoch-bound
// service bindings and the operation ledger. Derived from docs/game-core/05-contracts-and-data-model.md s4-5,
// 02-composition-and-propagation.md and P-007/P-010..P-013/P-046/P-050/P-051. Pure data and interfaces: no
// live ECS access, no resolver algorithm, no derivation.
#nullable enable
using System;
...
namespace GameCore.Contracts
{
    ...
    /// <summary>
    /// Serialized control-lane seam (P-002, P-051). Every mutation is submitted here, admitted against the last
