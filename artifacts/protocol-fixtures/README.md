...
Status: **Executed — 40 Pass, 0 Fail, 0 NotRun, 0 Blocked** on the Linux build host.
See `artifacts/gc-002/BUILD_REPORT.md` for toolchain, commands, test results and evidence limits.
...
`results.json` is generated by the real build-host run through
