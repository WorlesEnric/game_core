...
namespace GameCore.Content.Compiler
{
    ...
    public static class CatalogGenerator
    {
        ...
        public static CatalogGenerationReport Verify(string outputPath)
        {
            ...
            if (fileHash.StartsWith(CatalogEmitter.MismatchPrefix, StringComparison.Ordinal))
            {
                return Failure(
                    "the recorded CatalogFileHash does not match the file content (recorded " +
                    fileHash.Substring(CatalogEmitter.MismatchPrefix.Length) +
                    "); the file was edited by hand, truncated or generated by a different compiler revision");
            }
