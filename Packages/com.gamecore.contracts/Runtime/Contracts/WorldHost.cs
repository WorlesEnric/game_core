...
namespace GameCore.Contracts
{
    ...
    /// system type through the generated registry, so the contract stays free of Unity types (04 s4, P-039/P-040).
    /// </summary>
    ...
    /// <summary>
    /// Owned world lifecycle contract (P-002, P-035). One host owns one world; worlds never share runtime handles,
    ...
    /// <summary>
    /// Guarded execution contract (P-031, P-041, P-044). The driver owns step admission, ordered dispatch, fault
