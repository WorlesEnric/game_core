...
namespace GameCore.Contracts
{
    ...
    public enum FactoryKind
    {
        ...
        /// <summary>
        /// A precompiled closed generic handler entry point resolved by key (04 section 8).
        /// </summary>
        /// <remarks>
        /// GC-003 addition to the frozen contract surface: the W0 enum had no category for a generated handler
        /// registration, and reusing <see cref="SystemFactory"/> for it would misreport the registration kind in
        /// the catalog fingerprint. Enum member additions are listed in artifacts/gc-003/HANDOFF.md.
        /// </remarks>
        Handler = 10,
    }

    /// <summary>One registered generated key. Nothing here is instantiated or invoked by the contract.</summary>
    ...
    /// <summary>
    /// Read-only catalog lookup contract. Implementations are generated or explicitly registered; a consumer can
