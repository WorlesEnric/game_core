...
namespace GameCore.Contracts
{
    ...
    /// require world recreation, never wraparound). This contract exposes the pure arithmetic predicate only.</remarks>
    ...
    /// <remarks>Overflow policy is a protocol decision made by callers (P-005). This contract exposes the pure
