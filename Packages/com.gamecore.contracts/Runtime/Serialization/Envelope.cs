...
namespace GameCore.Contracts
{
    ...
    public enum EnvelopeError
    {
        ...
        /// <summary>A declared required schema field is absent from the document (05 s6).</summary>
        MissingRequiredField = 16,

        /// <summary>A declared schema field appears more than once; duplicate field ids are ambiguous.</summary>
        DuplicateField = 17,
    }
    ...
    public static class EnvelopeFormat
    {
        ...
        /// <summary>FNV-1a 64-bit offset basis and prime; the contract's corruption checksum.</summary>
    ...
    public sealed class EnvelopeReader
    {
        ...
        /// <summary>
        /// Moves the read cursor to an absolute document offset so a previously recorded field record can be
        /// re-read without a second pass. Generated serializers record record offsets during the validation walk
        /// and then read each declared field here. An offset outside the document rejects with
        /// <see cref="EnvelopeError.Truncated"/> rather than throwing.
        /// </summary>
        public bool TrySeekTo(int offset)
        {
