...
def emit_csharp(rows: list[dict]) -> str:
    ...
    out.append("            SchemaRoot = schemaRoot;\n")
    out.append("        }\n")
    out.append("\n")
    ...
    out.append("\n")
    out.append("        /// <summary>Generated registration kind.</summary>\n")
    ...
    out.append("\n")
    out.append("        /// <summary>True for a serializer root contributed by a declared schema.</summary>\n")
    out.append("        public bool SchemaRoot { get; }\n")
    out.append("    }\n")
    out.append("\n")
    ...
    out.append("        public static readonly string[] ClosedGenericRoots =\n")
    out.append("        {\n")
    for row in rows:
