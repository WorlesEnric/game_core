...
{
    /// <summary>
    /// Deterministic build-time generation of the GC-018 checkpoint catalog. This is a thin bridge: the catalog
    ...
    /// checkpoint catalog test asserts them against a fresh derivation.
    ///
    /// Callable from batchmode with
    /// <c>-executeMethod GameCore.Validation.Editor.CheckpointCatalogGenerator.GenerateCatalog</c>.
    ...
    /// </summary>
    public static class CheckpointCatalogGenerator
    {
        /// <summary>Project-relative path of the generated checkpoint catalog consumed by the checkpoint runtime.</summary>
        public const string RelativeOutputPath = "Assets/GameCore.Validation/GeneratedCheckpoint/CheckpointCatalog.g.cs";
        ...
        /// </summary>
        public const string RelativeDescriptionPath = "Catalogs/CheckpointCatalog.catalog.json";
